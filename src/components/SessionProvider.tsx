...
import { Context, createContext, type PropsWithChildren, useEffect, useMemo, useState } from 'react';
 ...
 */
export const SessionContext: Context<TSessionContextValue | undefined> = createContext?.<TSessionContextValue | undefined>(
  undefined
);

export const SessionProvider = ({ session: initialSession = null, children }: TSessionProviderProps) => {
